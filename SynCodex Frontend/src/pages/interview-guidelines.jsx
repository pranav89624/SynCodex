...
export default function InterviewGuidelines() {
  ...
  const handleStart = async () => {
    try {
      ...
      navigate("/interview-editor");
    } catch (err) {
      alert("Fullscreen request denied. Please allow it to continue the interview.");
  ...
  return (
    <div className="h-screen bg-[#21232f] text-white flex flex-col justify-center items-center text-center px-6">
      ...
      <p className="mb-2">Be respectful, stay on topic, and keep your mic muted when not speaking.</p>
      <p className="mb-2">Everything is monitored and recorded.</p>
      <p className="mb-6 text-sm text-gray-400">Click below to begin the interview session.</p>
