            ...
            <div className="h-[calc(100vh-4rem)] flex overflow-x-clip bg-[#21232f]">
                ...
                <div className="flex flex-col flex-1 h-full">
                    ...
                    <div className="flex overflow-hidden">
                        ...
                        <div className="flex flex-col gap-2 p-2 h-full w-1/3">
                            <div className="bg-[#fff] h-[200px] rounded-md"></div>
                            <div className="bg-amber-500 h-[200px] rounded-md"></div>
                            <div className="h-auto flex justify-between">
                                <div className="bg-amber-900 w-[47%] h-[120px] rounded-md"></div>
                                <div className="bg-amber-300 w-[47%] h-[120px] rounded-md"></div>
                            </div>
                            <div className="bg-amber-500 h-[200px] rounded-md"></div>
                        </div>
                    </div>
