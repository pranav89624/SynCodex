  ...
  return (
    <div className="fixed inset-0 bg-[#00000093] bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#3D415A] p-6 rounded-2xl shadow-lg w-[90%] max-w-md text-white relative">
        ...
        <input type="text" placeholder="Enter Room ID" className="w-full p-2 mb-3 rounded bg-[#21232f] text-white outline-none placeholder:text-white" />
        <label className="block font-open-sans mb-2">Password</label>
        <input type="password" placeholder="Password" className="w-full p-2 mb-4 rounded bg-[#21232f] text-white outline-none placeholder:text-white" />
