  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#00000093]">
      <div className="bg-[#3D415A] p-6 rounded-xl shadow-4xl w-94 text-white">
        ...
        <input
          className="w-full p-2 mb-3 bg-[#21232f] text-white placeholder:text-white outline-none rounded"
          type="text"
        ...
        <div className="flex items-center justify-between">
          <input
            className="w-[85%] p-2 mb-3 bg-[#21232f] text-white placeholder:text-white outline-none rounded"
            type="email"
            placeholder="Email person's email address"
          />
